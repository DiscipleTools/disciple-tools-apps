[![Build Status](https://travis-ci.com/DiscipleTools/disciple-tools-apps.svg?branch=master)](https://travis-ci.com/DiscipleTools/disciple-tools-apps)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```disciple_tools_apps()```
