...
class Disciple_Tools_Apps_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" || $post_type === "apps" ){
            $tiles["disciple_tools_apps"] = [ "label" => __( "Disciple Tools Apps", 'disciple-tools-apps' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" || $post_type === "apps" ){
             ...
             */
            $fields['disciple_tools_apps_text'] = [
                'name'        => __( 'Text', 'disciple-tools-apps' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-apps' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_apps',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields["disciple_tools_apps_multiselect"] = [
                "name" => __( 'Multiselect', 'disciple-tools-apps' ),
                "default" => [
                    "one" => [ "label" => __( "One", 'disciple-tools-apps' ) ],
                    "two" => [ "label" => __( "Two", 'disciple-tools-apps' ) ],
                    "three" => [ "label" => __( "Three", 'disciple-tools-apps' ) ],
                    "four" => [ "label" => __( "Four", 'disciple-tools-apps' ) ],
                ],
                "tile" => "disciple_tools_apps",
                "type" => "multi_select",
                "hidden" => false,
             ...
             */
            $fields["disciple_tools_apps_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "disciple_tools_apps",
                'default' => [
                    'first'   => [
                        "label" => _x( 'First', 'Key Select Label', 'disciple-tools-apps' ),
                        "description" => _x( "First Key Description", "Training Status field description", 'disciple-tools-apps' ),
                        'color' => "#ff9800"
                    ],
                    'second'   => [
                        "label" => _x( 'Second', 'Key Select Label', 'disciple-tools-apps' ),
                        "description" => _x( "Second Key Description", "Training Status field description", 'disciple-tools-apps' ),
                        'color' => "#4CAF50"
                    ],
                    'third'   => [
                        "label" => _x( 'Third', 'Key Select Label', 'disciple-tools-apps' ),
                        "description" => _x( "Third Key Description", "Training Status field description", 'disciple-tools-apps' ),
                        'color' => "#366184"
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === "contacts" || $post_type === "apps" ) && $section === "disciple_tools_apps" ){
            /**
...
Disciple_Tools_Apps_Tile::instance();
